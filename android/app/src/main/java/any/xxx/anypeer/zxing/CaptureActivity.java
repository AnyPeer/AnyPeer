...
import any.xxx.anypeer.zxing.decoding.CaptureActivityHandler;
import any.xxx.anypeer.zxing.decoding.InactivityTimer;
import any.xxx.anypeer.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(any.xxx.anypeer.R.layout.activity_code_scan);
	...
	private void initControl() {
		viewfinderView = (ViewfinderView) findViewById(any.xxx.anypeer.R.id.viewfinder_view);
		mTitle = (TextView) findViewById(any.xxx.anypeer.R.id.common_title_msg);
		mTitle.setText(R.string.menu_qrcode);
		mGoHome = (ImageView) findViewById(any.xxx.anypeer.R.id.img_back);
	...
	protected void onResume() {
		super.onResume();
		SurfaceView surfaceView = (SurfaceView) findViewById(any.xxx.anypeer.R.id.preview_view);
	...
	public void handleDecode(com.google.zxing.Result result, Bitmap barcode) {
		...
		if (!isNoCute) {
			if (TextUtils.isEmpty(resultString)) {
				...
				if (resultString.startsWith("JUNS_Chat@User")) {
...
//							new BasicNameValuePair(Constants.NAME, name[1]));
				} else if (resultString.startsWith("JUNS_Chat@getMoney")) {
