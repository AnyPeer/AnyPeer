package any.xxx.anypeer.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		maskColor = resources.getColor(any.xxx.anypeer.R.color.viewfinder_mask);
		resultColor = resources.getColor(any.xxx.anypeer.R.color.result_view);
		frameColor = resources.getColor(any.xxx.anypeer.R.color.viewfinder_frame);
		laserColor = resources.getColor(any.xxx.anypeer.R.color.viewfinder_laser);
		resultPointColor = resources.getColor(any.xxx.anypeer.R.color.possible_result_points);
		scannerAlpha = 0;
